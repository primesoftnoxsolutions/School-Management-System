...
export default function RollNoSlipsManagementPage({ dark = false }) {
  ...
  const renderSlip = (student, studentIndex, editable = false) => {
    ...
    return (
      <div key={student._id || "template"} className="mx-auto max-w-6xl overflow-hidden rounded-xl border-2 border-blue-700 bg-white shadow-[0_18px_44px_rgba(37,99,235,0.14)]">
    ...
    <section className="relative space-y-5">
      <style>{`
        @media print {
          ...
          .roll-slip-print-root { display: block !important; position: absolute !important; inset: 0 !important; padding: 18px !important; background: white !important; }
          .roll-slip-print-page { break-after: page; page-break-after: always; }
            ...
            <>
              ...
              {students.map((student, index) => (
                <div key={student._id || student.admissionNo || index} className="grid gap-3 border-b border-blue-50 px-4 py-3 text-sm last:border-b-0 md:grid-cols-[6rem_1fr_1fr_auto_auto]">
                  ...
                  <span className="font-bold text-slate-950">{getStudentName(student)}</span>
