...
function DateSheetPreview({ selectedClass, examTerm, rows, releaseAt, onRowChange }) {
  return (
    <div className="date-sheet-print-card overflow-hidden rounded-xl border-4 border-blue-900 bg-white p-5 text-blue-950 shadow-[0_18px_44px_rgba(37,99,235,0.14)]">
      ...
      <div className="mt-4 grid overflow-hidden rounded-md border border-blue-300 md:grid-cols-2">
        ...
        <div className="px-4 py-3 text-sm font-black uppercase">
          ...
          {rows.map((row, index) => (
            <tr key={row.subject}>
              ...
              <td className="border border-blue-300 p-0">
                <input
                  type="date"
                  className="h-12 w-full bg-transparent px-2 text-center font-bold text-blue-900 outline-none focus:bg-blue-50"
                  value={row.date}
              ...
              <div className="w-full max-w-7xl rounded-2xl bg-blue-50 p-4 shadow-2xl">
                <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-0.5 text-xs font-semibold text-slate-600">Set term, release time, and edit dates directly in the sheet.</p>
                  </div>
                ...
                <select className={`${inputClass} w-full`} value={selectedStudentId} onChange={(event) => setSelectedStudentId(event.target.value)}>
                  ...
                  {students.map((student) => (
                    <option key={student._id} value={student._id}>
                      {student.rollNo || student.rollNumber || student.admissionNo || "-"}
                    </option>
                  ))}
                </select>
              </Field>
