...
export default function LeavingCertificatePreview({ cert, onClose }) {
    ...
    win.document.write(`<!DOCTYPE html><html><head><title>${cert.certificateNo}</title>
      <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .wm{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:110px;font-weight:bold;opacity:.04;pointer-events:none}
  ...
  const printBody = (
    <div className="cert">
      <div className="inner">
        <div className="wm">NIPS</div>
        <header className="head">
          <div className="logo">N</div>
          <h1>Naseer Ideal Public School</h1>
          <p className="sub">Excellence in Education Since 1990</p>
          <p className="contact">Main Campus, City — Phone: +92 300 0000000</p>
          <div className="divider" />
          <p className="title">School Leaving Certificate</p>
          <p className="no">Certificate No: {cert.certificateNo}</p>
        </header>
        <div>
          <p className="intro">
            This is to certify that <strong>{cert.studentName}</strong>, son/daughter of{" "}
            <strong>{cert.fatherName || "—"}</strong>, bearing Roll No. <strong>{cert.rollNumber || "—"}</strong>,
            was a bonafide student of this institution and has been granted a School Leaving Certificate as per record.
          </p>
          <div className="box">
        ...
        <footer className="foot">
          <div className="issued">
            <p><strong>Issued on:</strong> {formatDate(cert.createdAt || new Date())}</p>
            <p style={{ marginTop: 6, maxWidth: 240 }}>Official computer-generated certificate — Naseer Ideal Public School.</p>
          </div>
          <div>
            <div className="stamp">OFFICIAL<br />SEAL</div>
            <div className="line" />
            <p className="sign">Principal</p>
            <p className="sign-sub">Naseer Ideal Public School</p>
          </div>
        </footer>
      </div>
    </div>
          ...
          <div className="relative mx-auto max-w-3xl border-[3px] border-double border-[#1e3a5f] bg-[#fffdf8] p-1.5 shadow-inner">
            <div className="relative border border-amber-600/50 px-5 py-8 sm:px-10 sm:py-10">
              ...
              <header className="relative z-10 border-b-2 border-[#1e3a5f] pb-6 text-center">
                ...
                <p className="mt-1.5 text-sm italic text-slate-600">Excellence in Education Since 1990</p>
              ...
              <div className="relative z-10 mt-7">
                <p className="text-justify text-sm leading-8 text-slate-700 sm:text-[15px]">
                  ...
                  this institution and has been granted a School Leaving Certificate as per record.
                </p>
              ...
              <footer className="relative z-10 mt-9 flex flex-col gap-8 border-t-2 border-[#1e3a5f] pt-6 sm:flex-row sm:items-end sm:justify-between">
                <div className="text-xs leading-relaxed text-slate-500">
                  <p>
                    ...
                    {formatDate(cert.createdAt || new Date())}
                  </p>
                  <p className="mt-1 max-w-xs text-[11px] text-slate-400">
                    Official computer-generated certificate — Naseer Ideal Public School.
                  </p>
                </div>
