          ...
          <div className="flex items-center gap-2">
            ...
            {onDemoReset ? (
              ...
              <button
                ...
                title="Demo only — clears attendance for the selected date"

                className={`rounded-lg border px-2.5 py-1.5 text-xs font-semibold transition disabled:opacity-50 ${

                  dark

                    ? "border-[#ff9800]/30 bg-[#ff9800]/10 text-[#ff9800] hover:bg-[#ff9800]/15"
              ...
              >
                ...
                {demoResetting ? "Resetting..." : "Attendance Reset"}
