...
export default function TopHeader({ user, dark = false, onToggleTheme }) {
  ...
  return (
    ...
    <header className="mb-4 flex items-center gap-4 bg-transparent px-5 py-4 lg:px-6">
      ...
      <div className="relative min-w-0 flex-1">
        ...
        <span className={`pointer-events-none absolute left-5 top-1/2 -translate-y-1/2 ${dark ? "text-[#9e9e9e]" : "text-slate-400"}`}>⌕</span>
